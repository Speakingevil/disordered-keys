...
public class DisorderedKeysScript : MonoBehaviour
{
    ...
    public string TwitchHelpMessage = "Use '!{0} press 1 2 3 4' to press key 1, 2 3 & 4! BUT, for time keys use '!{0} press x at y'! For ex. '{0} press 1 at 22' will press the 1st key when the seconds digits are 22. Put every time key into separate commands and don't chain it together with other keys!";
