...
public class DisorderedKeysScript : MonoBehaviour
{
    ...
    public string TwitchHelpMessage = "Use '!{0} press <key> <on/at XX>. Command is chainable with semicolon(;), time commands is optional. Or !{0} colorblind for colorblind support.";
